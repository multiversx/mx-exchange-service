...
import { FarmsStateServiceProvider } from 'src/modules/dex-state/mocks/farms.state.service.mock';
import { StakingFarmsStateServiceProvider } from 'src/modules/dex-state/mocks/staking.farms.state.service.mock';
    ...
    beforeAll(async () => {
        module = await Test.createTestingModule({
            ...
            providers: [
                ...
                StakingFarmsStateServiceProvider,
            ],
        }).compile();
    });
