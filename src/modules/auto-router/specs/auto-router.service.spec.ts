...
describe('AutoRouterService', () => {
    ...
    it('should get swap data for multi swap with amountOut', async () => {
        ...
        expect(swap).toEqual({
            ...
            tokenInID: 'USDC-1111',
            tokenOutID: 'TOK2-2222',
            tokenInExchangeRate: '994007755618460736',
            tokenOutExchangeRate: '1006028367834827360',
            tokenInExchangeRateDenom: '0.994007755618460736',
            tokenOutExchangeRateDenom: '1.00602836783482736',
            tokenInPriceUSD: '1',
            tokenOutPriceUSD: '100',
            amountIn: '508044325756587816',
            amountOut: '500000000000000000',
            intermediaryAmounts: [
                '503014183917413680',
                '626881033727',
            ...
            fees: ['0.00150904255175224104', '0.000000001880643101181'],
            pricesImpact: ['0.0000626881033727', '0.0000625'],
            pairs: [
                {
                    address:
                        'erd1qqqqqqqqqqqqqpgqq67uv84ma3cekpa55l4l68ajzhq8qm3u0n4s20ecvx',
