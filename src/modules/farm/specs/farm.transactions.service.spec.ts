...
describe('FarmService', () => {
    ...
    it('should get enter farm transaction', async () => {
        const transaction = await service.enterFarm(Address.Zero().bech32(), {
            ...
            tokens: [{ tokenID: 'LPT-1111', nonce: 0, amount: '1000' }],
            lockRewards: true,
        });
        expect(transaction).toEqual({
            ...
            data: encodeTransactionData(
                'MultiESDTNFTTransfer@erd18h5dulxp5zdp80qjndd2w25kufx0rm5yqd2h7ajrfucjhr82y8vqyq0hye@01@05498987698094944561@@1000@enterFarmAndLockRewards',
            ),
    ...
    it('should get exit farm transaction', async () => {
        ...
        expect(transaction).toEqual({
            ...
            data: encodeTransactionData(
                'ESDTNFTTransfer@05065797708937311028@01@1000@erd18h5dulxp5zdp80qjndd2w25kufx0rm5yqd2h7ajrfucjhr82y8vqyq0hye@07311709943153914477',
            ),
            chainID: elrondConfig.chainID,
            version: 1,
            options: undefined,
    ...
    it('should get claim rewards transaction', async () => {
        ...
        expect(transaction).toEqual({
            ...
            gasLimit:
                ...
                gasConfig.lockedAssetCreate,
            data: encodeTransactionData(
                'ESDTNFTTransfer@05065797708937311028@01@1000@erd18h5dulxp5zdp80qjndd2w25kufx0rm5yqd2h7ajrfucjhr82y8vqyq0hye@claimRewards',
            ),
            chainID: elrondConfig.chainID,
            version: 1,
            options: undefined,
    ...
    it('should get migrate to new farm transaction', async () => {
        ...
        expect(transaction).toEqual({
            ...
            data: encodeTransactionData(
                'ESDTNFTTransfer@05065797708937311028@01@1000@erd18h5dulxp5zdp80qjndd2w25kufx0rm5yqd2h7ajrfucjhr82y8vqyq0hye@migrateToNewFarm@erd1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqq6gq4hu',
            ),
            chainID: elrondConfig.chainID,
            version: 1,
            options: undefined,
    ...
    it('should get set farm migration config transaction', async () => {
        ...
        expect(transaction).toEqual({
            ...
            data: encodeTransactionData(
                'setFarmMigrationConfig@erd18h5dulxp5zdp80qjndd2w25kufx0rm5yqd2h7ajrfucjhr82y8vqyq0hye@05065797708937311028@erd1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqq6gq4hu@erd1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqq6gq4hu',
            ),
            chainID: elrondConfig.chainID,
            version: 1,
            options: undefined,
    ...
    it('should get register farm token transaction', async () => {
        ...
        expect(transaction).toEqual({
            ...
            data: encodeTransactionData(
                'registerFarmToken@FarmingToken-1111@05065797708937244977@18',
            ),
            chainID: elrondConfig.chainID,
            version: 1,
            options: undefined,
    ...
    it('should get merge farm tokens transaction', async () => {
        ...
        expect(transaction).toEqual({
            ...
            data: encodeTransactionData(
                'MultiESDTNFTTransfer@erd1qqqqqqqqqqqqqqqpqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqzllls8a5w6u@02@05065797708937311028@@0100@05065797708937311028@@0100@mergeFarmTokens',
            ),
            chainID: elrondConfig.chainID,
            version: 1,
            options: undefined,
