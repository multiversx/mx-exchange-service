...
describe('WeeklyRewardsSplittingComputeService', () => {
    ...
    it(
        'computeUserAllRewards' + 'currentWeek == userProgress.week',
        async () => {
            const currentWeek = 10;
            const energy = {
                amount: '100',
            ...
            const rewards = await service.computeUserAllRewards(
                dummyScAddress,
                dummyUserAddress,
            );
            expect(rewards).toEqual([]);
    ...
    it(
        'computeUserAllRewards' + 'same rewards twice in every week',
        async () => {
            const currentWeek = 10;
    ...
    it(
        ...
        async () => {
            ...
            let usdValue =
                await service.computeTotalLockedTokensForWeekPriceUSD(
                    dummyScAddress,
                    10,
                    '0',
                );
    ...
    it(
        ...
        async () => {
            ...
            apr = await service.computeAprGivenLockedTokensAndRewards(
                dummyScAddress,
                10,
                '1000',
                [
...
async function createService(handlers: {
    ...
    const weeklyGetter = new WeeklyRewardsSplittingGetterServiceMock(
        handlers.weeklyGetter,
    );
